...
const init = () => {
    const tieneSoporteUserMedia = () =>
        !!(navigator.mediaDevices.getUserMedia || navigator.webkitGetUserMedia || navigator.mediaDevices.getUserMedia || navigator.msGetUserMedia)
...
console.log(videoElement.videoWidth);
        ...
        navigator.mediaDevices.getUserMedia({
            ...
            .then(stream => {
                ...
                mediaRecorder.addEventListener("stop", () => {
                   ...
                   // const RUTA_SERVIDOR = "saveVideo.php";
                    const RUTA_SERVIDOR = "guardar_video.php";
                    //const RUTA_SERVIDOR = "saveVideo.php?idUser=" + idUser;
                    $duracion.textContent = "Guardando vídeo, espere un momento...";
                    fetch(RUTA_SERVIDOR, {
                            method: "POST",
                            body: formData,
                        })
                        ...
                        .then(respuestaComoTexto => {
                            ...
                            //$duracion.innerHTML = `<strong>Vídeo subido correctamente.</strong>&nbsp; <a target="_blank" href="videos/${respuestaComoTexto}">Abrir</a>`
                            $duracion.innerHTML = `Listo!, &nbsp; <a target='_blank' href='enviarFile.php?video=${respuestaComoTexto}'>enviar mi vídeo al correo</a>`
                        })
                });
            })
            .catch(error => {
    ...
    $(function(){
        $("#btnComenzarGrabacion").click(function(){
            ...
            $("#duracion").fadeIn(100); 
            $("#btnDetenerGrabacion").fadeIn(100); 
            ...
            $("#nuewfiltro").hide(100);
            $("#btn-front").hide(100);
            $("#btnComenzarGrabacion").hide(100); //Ocultar
        });

        $("#btnDetenerGrabacion").click(function(){
            $("#btnDetenerGrabacion").hide(100); 
        });
    });
